...
BOT_TOKEN = "7591622825:AAGJg9H0h9uss9X5bI1RsExjz9YSwLaixkU"
...
async def send_main_menu(update):
    keyboard = [
        ...
        [InlineKeyboardButton("✉️ ফিডব্যাক পাঠান", url="https://t.me/Swygen_bd")]  # তোমার ইউজারনেম বসাও
    ]
...
async def send_question(context, chat_id, user_id):
    ...
    if not user["answered"]:
        try:
            ...
            pass
        await context.bot.send_message(chat_id, f"⏰ সময় শেষ!\nসঠিক উত্তর ছিল: {user['correct']}")
